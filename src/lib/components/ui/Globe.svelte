<script lang="ts">
	...
	onMount(() => {
		...
		// Initialize the globe with specific options
		...
		return () => {
			...
			globe.destroy(); // Clean up the globe instance
		};
	});
</script>

<main class={cn('absolute inset-0 mx-auto aspect-[1/1] w-full max-w-[300px]', className)}>
	<canvas
